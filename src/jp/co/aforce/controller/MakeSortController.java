...
@WebServlet("/MakeSortController")
public class MakeSortController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (sort.equals("安い順")) {
				...
				try {
					List<ProductBean> list = dao.makelow();
				...
				try {
					List<ProductBean> list = dao.makehigh();
					request.setAttribute("title", "商品一覧");
					session.setAttribute("list", list);
				...
				try {
					List<ProductBean> list = pdao.make();
					request.setAttribute("title", "商品一覧");
