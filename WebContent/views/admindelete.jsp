...
<div class="logout">
	...
	<br>
	<p class="text">削除する商品の番号を入力してください。</p>
	<br>
	<p class="text">${msg}</p>
	<br>
	<form
		...
		method="post">
		<p class="text">
			商品番号 <input type="text" name="product_num" value="${b.product_num}">
		...
		<p class="text">
			商品名 <input type="text" name="product_name" value="${b.product_name}"
				readonly="readonly"> <input type="hidden" value="削除"
				name="se">
		</p>
		<br>
		<p class="text">
			商品説明
			<textarea name="description" rows="4" cols="40" readonly="readonly">${b.description}</textarea>
		</p>
		<br>
		<p class="text">
			価格 <input type="text" name="product_price" value="${b.product_price}"
				readonly="readonly">円
		</p>
		...
		<br> <input type="submit" value="戻る" class="adminbtn" name="form">
		<input type="reset" value="リセット" class="adminbtn"> <input
			type="submit" class="adminbtn" value="削除" name="form"
