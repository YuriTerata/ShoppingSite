	...
	<form
		...
		<p class="text">
			■ID<br> <input type="text" name="member_id" value="${member_id}"
				...
				class="loginbtn" name="menu"><input type="hidden" value="更新"
				name="se">
		</p>
		<br>
		...
		<section class=regist>
			...
			<button type="submit" name="menu" class="loginbtn" value="更新"
				onClick="return Confirm()">更新</button>
		</section>
